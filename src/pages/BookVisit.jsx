...
export default function BookVisit() {
  return (
    <div className="flex flex-col bg-background selection:bg-primary selection:text-white">
        ...
        <div className="container mx-auto px-5 relative z-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          >
            <div className="space-y-3 lg:space-y-4">
              ...
              <h1 className="text-[clamp(2.5rem,9vw,5.5rem)] md:text-7xl lg:text-[8rem] font-black uppercase tracking-tight leading-[0.9] lg:leading-[0.85]">
          ...
          >
            <div className="relative aspect-[4/5] max-w-sm lg:max-w-md mx-auto lg:mr-0 lg:ml-auto overflow-hidden shadow-2xl border border-white/5">
              <img
                src="/assets/book_visit_hero_v2.jpg"
                alt="Athlete"
                className="w-full h-full object-cover object-center scale-105 brightness-[0.95] contrast-[1.1] transition-transform duration-1000 hover:scale-110"
                loading="eager"
              />
      ...
      <section className="relative z-20 -mt-16 lg:-mt-32 pb-14 lg:pb-48">
        <div className="container mx-auto px-5">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative max-w-4xl mx-auto bg-white dark:bg-charcoal shadow-4xl border-t-4 border-primary p-6 lg:p-14 space-y-10 lg:space-y-12"
          >
            <div className="space-y-3 lg:space-y-4">
            ...
            <form className="space-y-8 lg:space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="bg-white/[0.03] dark:bg-white/5 border border-white/10 py-3 lg:py-5 px-4 lg:px-5 rounded-none text-sm lg:text-base focus:ring-2 focus:ring-primary transition-all h-auto"
                  />
                </div>
                <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                  {["Morning", "Afternoon", "Evening", "Night"].map((time, i) => (
                    <button
                      ...
                      type="button"
                      className={cn(
                        "py-3 lg:py-4 px-4 uppercase font-black text-[9px] lg:text-[10px] tracking-widest transition-all border border-white/5 active:scale-[0.98]",
                        i === 1 ? "bg-primary text-white border-primary shadow-lg" : "bg-white/[0.03] dark:bg-white/5 text-white/40 hover:bg-primary/20 hover:text-white hover:border-primary/50"
                      )}
                    >
                      {time}
                    </button>
              ...
              <div className="space-y-4 lg:space-y-6 pt-4">
                <Button className="w-full max-w-[300px] mx-auto bg-primary hover:bg-white hover:text-black text-white font-black uppercase py-4 lg:py-6 rounded-none text-sm lg:text-base tracking-[0.2em] shadow-xl group active:scale-[0.98] active:shadow-inner transition-all flex items-center justify-center border border-primary hover:border-white">
                  Claim My Free Visit <ArrowRight className="ml-3 lg:ml-4 h-4 w-4 lg:group-hover:translate-x-2 transition-transform" />
                </Button>
                <p className="text-center text-[8px] lg:text-[10px] uppercase font-bold tracking-widest opacity-40 max-w-[40ch] mx-auto leading-relaxed">
                  No credit card required. Confirmation sent via SMS.
                </p>
              </div>
            </form>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-black/40 to-transparent" />
               <div className="absolute bottom-4 left-4 right-4 lg:bottom-8 lg:left-8 lg:right-8 bg-white dark:bg-charcoal p-5 lg:p-8 shadow-2xl flex items-center justify-between border-b-4 border-primary">
                 <div className="space-y-0.5 lg:space-y-1">
                    ...
                    <p className="font-black uppercase tracking-tight italic text-xs lg:text-sm pr-4">Karmin Arcade, 16/116 A, Civil Lines, Kanpur</p>
                 </div>
                 <a href="https://www.google.com/maps/place/Perfect+Fitness+Gym/@26.4744588,80.3510863,17z/data=!3m1!4b1!4m6!3m5!1s0x399c388f4be88959:0xe1e9a7d468fbf16!8m2!3d26.4744588!4d80.3536612!16s%2Fg%2F11cjj97h8y?entry=ttu&g_ep=EgoyMDI2MDQxNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className="w-10 h-10 lg:w-12 lg:h-12 bg-primary flex items-center justify-center active:scale-95 transition-transform shrink-0 hover:bg-white hover:text-black group/nav">
                    <Navigation className="w-5 h-5 lg:w-6 lg:h-6 text-white fill-white group-hover/nav:text-black group-hover/nav:fill-black" />
                 </a>
               </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-10 lg:space-y-14">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <a href="https://wa.me/919807490497" target="_blank" rel="noopener noreferrer" className="bg-white/[0.02] dark:bg-white/5 p-6 lg:p-8 flex items-center gap-5 lg:gap-6 group kinetic-hover active:scale-[0.98] transition-all border border-white/[0.05] hover:border-primary">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-primary/5 flex items-center justify-center shrink-0 group-hover:bg-primary transition-colors">
                      <Phone className="w-4 h-4 lg:w-5 lg:h-5 text-primary group-hover:text-white" />
                    </div>
                    <div className="space-y-1">
                      <span className="text-[9px] lg:text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-primary transition-colors">Call Us</span>
                      <p className="font-black text-xs lg:text-sm uppercase tracking-tight">+91 98074 90497</p>
                    </div>
                  </a>
                  <a href="mailto:contact@perfectfitness.com" className="bg-white/[0.02] dark:bg-white/5 p-6 lg:p-8 flex items-center gap-5 lg:gap-6 group kinetic-hover active:scale-[0.98] transition-all border border-white/[0.05] hover:border-primary">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-primary/5 flex items-center justify-center shrink-0 group-hover:bg-primary transition-colors">
                      <Mail className="w-4 h-4 lg:w-5 lg:h-5 text-primary group-hover:text-white" />
                    </div>
                    <div className="space-y-1">
                      <span className="text-[9px] lg:text-[10px] font-black uppercase tracking-widest text-white/40 group-hover:text-primary transition-colors">Email</span>
                      <p className="font-black text-xs lg:text-sm uppercase tracking-tight lowercase">contact@perfectfitness.com</p>
                    </div>
                  </a>
              </div>

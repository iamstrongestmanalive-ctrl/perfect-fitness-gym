...
const images = [
   { src: "/assets/gym1.jpg", title: "Strength Arena", area: "Hammer Strength" },
   { src: "/assets/gym2.jpg", title: "Main Floor", area: "Industrial Design" },
   { src: "/assets/gym3.jpg", title: "Cardio Row", area: "High Endurance" },
   { src: "/assets/gym4.jpg", title: "Heavy Duty", area: "Free Weights" },
   { src: "/assets/gym5.jpg", title: "Functional", area: "Performance Turf" },
   { src: "/assets/hero_interior.png", title: "Recovery", area: "Amenities" },
]
            ...
            <div className="container mx-auto px-5">
               ...
               <div className="mt-14 lg:mt-32 text-center p-8 lg:p-20 bg-surface dark:bg-white/5 border border-white/[0.05] relative overflow-hidden group">
                  <div className="relative z-10 space-y-6 lg:space-y-8">
                     ...
                     <Button asChild className="w-full max-w-[260px] bg-primary text-white hover:opacity-90 font-black uppercase text-sm lg:text-xl py-3 lg:py-10 px-10 lg:px-20 rounded-none h-auto transition-all shadow-3xl active:scale-[0.97] active:shadow-inner will-change-transform mx-auto">
                        <Link to="/book-visit">Book Visit <ArrowRight className="ml-2 w-5 h-5 lg:w-6 lg:h-6" /></Link>
                     </Button>
                  </div>
